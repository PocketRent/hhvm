...
if (EXISTS "${CCLIENT_INCLUDE_PATH}/linkage.c")
    ...
    CONTAINS_STRING("${CCLIENT_INCLUDE_PATH}/linkage.c" auth_gss CCLIENT_HAS_AUTH_GSS)
elseif(EXISTS "${CCLIENT_INCLUDE_PATH}/linkage.h")
    ...
    CONTAINS_STRING("${CCLIENT_INCLUDE_PATH}/linkage.h" auth_gss CCLIENT_HAS_AUTH_GSS)
endif()

if (NOT CCLIENT_HAS_AUTH_GSS)
